# Code & Clarity — LinkedIn Business Page Copy

*Same voice rules and claims discipline as Site Copy v2: verdict first, receipts over rhetoric, honest disqualification out loud, no solutions/journey/unlock/empower, no emoji, American spelling. The only numbers are externally sourced (MIT) or contractual facts. Character limits verified against LinkedIn's current field caps.*
...
No photo, no stock, no gradient mesh. Warm ivory field (`#faf9f5`), warm near-black ink, one thin terracotta→gold rule — the site's visual system, so the page and site read as the same publication.
...
## 7. Pinned post (page launch)

> Code & Clarity has a company page now. Here's the honest version of what we do, since "AI consulting" tells you nothing.
>
...
*(No hashtags. One link, at the end. Reads like a person because it argues like one.)*
...
- One receipt per post (MIT, McKinsey, a contractual fact). Never an invented percentage.
- Say who it's not for at least once a month. The disqualification *is* the brand.
- No emoji, no hashtag piles, no "thoughts?" engagement bait, no em-dash chains.
- If a post could appear on any consultancy's page, cut it.
