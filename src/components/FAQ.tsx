...
const FAQS = [
  ...
  },
  {
    ...
    a: "Three honest cases. If your board needs a Big Four logo on the deck for political cover, buy the logo — we can't provide it. If you need a $5K chatbot configured, a freelancer is the right answer and we'll say so. And if you want a strategy document with no intention of building anything, we're a bad fit on purpose: every engagement we take is designed to end in something that runs.",
  },
  {
    q: 'What does a typical engagement look like?',
    a: "It starts with a 45-minute diagnostic, not a pitch. Audits and strategy run a few weeks and end in an executable decision. Training programs are built around your team's actual tools. Implementation runs to a clearly defined scope with weekly working output. All three combine when the problem calls for it.",
  },
  {
    q: 'How are you different from a traditional AI consultancy?',
    a: "Accountability. Traditional firms separate the people who write the strategy from the people who execute it — which is how you get LLM architecture recommendations from people who've never shipped one. Here the recommendation comes from the people who will build it, which keeps the recommendation honest. MIT's enterprise research found external implementation partners succeed roughly twice as often as internal builds; we exist to be that partner, not the deck before it.",
  },
  {
  ...
  },
  {
    ...
    a: 'Vendor platform, selective custom build, or hybrid — chosen on your requirements and three-year cost of ownership. We architect it, integrate it with your existing systems, deploy to production, and hand over completely: code, docs, runbooks, trained team.',
  },
  {
    q: 'What does working with you look like day to day?',
    a: "Scope in writing before anything starts. Working output every week. At close: systems that run, documentation written for maintainers, and a knowledge transfer session. You should be able to operate and extend everything without us — that's the definition of done.",
  },
  {
    q: 'What does it cost?',
...
export default function FAQ() {
  return (
    <section id="section-faq" className="section" aria-label="Frequently asked questions">
