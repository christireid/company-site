...
const ids = ['section-hero','section-manifesto','section-services','section-product','section-transform','section-contrast','section-process','section-faq','section-contact']
for (const id of ids) {
